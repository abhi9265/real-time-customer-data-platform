...
def test_customer_state_aggregates_incremental_events(spark):
    df = spark.createDataFrame([
        ("usr-1", "evt-1", "ses-1", "user_login", datetime(2026, 8, 18, 10, 0)),
        ("usr-1", "evt-2", "ses-2", "order_created", datetime(2026, 8, 18, 10, 5)),
        ("usr-1", "evt-3", "ses-2", "payment_completed", datetime(2026, 8, 18, 10, 6)),
        ("usr-2", "evt-4", "ses-3", "user_login", datetime(2026, 8, 18, 11, 0)),
