...
def test_product_event_contract_accepts_valid_event():
    ...
    event = {
        "event_id": "evt-001", "event_type": "product_viewed", "event_version": 1,
        "event_timestamp": "2026-08-18T10:00:00Z", "user_id": "usr-001",
        "session_id": "ses-001", "product_id": "prd-001", "source": "web",
        "trace_id": "trace-001", "properties": {"page": "product"},
    }
...
def test_order_contract_rejects_negative_amount():
    ...
    event = {
        ...
        "event_timestamp": "2026-08-18T10:00:00Z", "user_id": "usr-001",
        "source": "web", "trace_id": "trace-002",
        "properties": {"order_id": "ord-001", "currency": "USD", "amount": -10},
    }
